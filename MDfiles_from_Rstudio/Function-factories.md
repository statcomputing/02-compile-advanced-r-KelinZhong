...
#>     x ^ exp
#>   }
#> <environment: 0x0000000014649b38>

cube
#> function(x) {
#>     x ^ exp
#>   }
#> <bytecode: 0x00000000123fcea8>
#> <environment: 0x0000000013cadab8>
```
...
```r
env_print(square)
#> <environment: 0000000014649B38>
#> parent: <environment: global>
#> bindings:
#>  * exp: <dbl>

env_print(cube)
#> <environment: 0000000013CADAB8>
#> parent: <environment: global>
#> bindings:
#>  * exp: <dbl>
```
...
#> <bytecode: 0x000000001a3b75e8>
#> <environment: 0x0000000013a0f8d8>
plot_dev("png")
#> function(...) grDevices::png(..., res = dpi, units = "in")
#> <bytecode: 0x000000001a567798>
#> <environment: 0x000000001a81afc0>
```
...
#>   }
#> <bytecode: 0x00000000123fcea8>
#> <environment: 0x000000001a3ae618>
```
