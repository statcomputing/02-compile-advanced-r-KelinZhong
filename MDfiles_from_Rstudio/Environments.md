...
```r
e1
#> <environment: 0x0000000014780ac0>
```
...
```r
env_parent(e2b)
#> <environment: 0x0000000015151f08>
env_parent(e2a)
...
```r
env_parents(e2b)
#> [[1]]   <env: 0000000015151F08>
#> [[2]] $ <env: global>
env_parents(e2d)
#> [[1]]   <env: 0000000012865F38>
#> [[2]] $ <env: empty>
```
...
plus_one
#> function(y) x + y
#> <environment: 0x00000000126b90d0>
```
