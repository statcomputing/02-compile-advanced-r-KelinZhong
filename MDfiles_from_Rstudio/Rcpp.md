...
#> 1 sum(x)        1.1μs    1.3μs   636286.        0B        0
#> 2 sumC(x)       2.4μs    4.1μs   233601.    2.49KB        0
#> 3 sumR(x)      35.3μs     38μs    23864.    33.5KB        0
```
...
#>   expression          min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>     <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 pdistR(0.5, y)   9.88ms  10.38ms      89.8    7.63MB     46.7
#> 2 pdistC(0.5, y)   7.79ms   8.28ms     118.     7.63MB     36.3
```
...
#>   expression              min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr>         <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 gibbs_r(100, 10)     4.42ms   5.03ms      190.    4.97MB     35.9
#> 2 gibbs_cpp(100, 10)    216μs  265.4μs     3474.     4.1KB     23.7
```
...
#>   expression      min   median `itr/sec` mem_alloc `gc/sec`
#>   <bch:expr> <bch:tm> <bch:tm>     <dbl> <bch:byt>    <dbl>
#> 1 vacc1        2.06ms   2.44ms      394.    7.86KB    23.1 
#> 2 vacc2        82.8μs   91.3μs     9315.  148.84KB    24.7 
#> 3 vacc3        49.4μs   50.1μs    18012.   14.48KB     6.13
```
